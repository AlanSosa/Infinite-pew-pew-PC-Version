    ...
    public class BonusClock:Messages.Message
    {
        ...
        public override void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            if (EnemySpawner.BonusMode)
            {
                ...
                spriteBatch.DrawString(this.Font, ( ((int)(milisecondsTimer / 1000)).ToString().Length < 2 ? "0" + (int)(milisecondsTimer / 1000) : ""+ (int)(milisecondsTimer / 1000) ), shakeOffset + Position, ColorUtil.HSVToRGB(10f, factor,1f) * .6f, 0f, Size / 2f, 2f, SpriteEffects.None, 0f);
                spriteBatch.DrawString(this.Font, ":" + ( (int)(milisecondsTimer % 1000)>0?(int)(milisecondsTimer % 1000)+"":"00"  ), shakeOffset + Position + new Vector2(90, 39), ColorUtil.HSVToRGB(1f, factor, 1f) * .6f, 0f, Size / 2f, 1f, SpriteEffects.None, 0f);
