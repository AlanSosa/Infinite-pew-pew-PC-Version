...
namespace ThridWolrdShooterGame.Entites
{
    public class PlayerShip : Entity
    {
        ...
        private float timeUntilActive = 90 * 2f;
        ...
        public override void Update(Microsoft.Xna.Framework.GameTime gametime)
        {
            ...
            if (aim.LengthSquared() > 0 && cooldownRemaining <= 0)
            {
                ...
                if (equippedItem != ItemSpawner.ITEMS.WOAH )
                {
                    if (equippedItem == ItemSpawner.ITEMS.PEW)
                    {
                        ...
                        GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, this.Position + offset, midColor * alpha, 15f * 2f, new Vector2(0.5f, 1),
                    ...
                    else if (equippedItem == ItemSpawner.ITEMS.PEW_PEW)
                    {
                        ...
                        GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, this.Position + offset, sideColor * alpha, 15f *2f, new Vector2(0.5f, 1),
                        new ParticleState(velMid, ParticleType.ENEMY));
                    ...
                    if (equippedItem != ItemSpawner.ITEMS.PEW && equippedItem != ItemSpawner.ITEMS.BOINGY_BOINGY)
                    {
                        ...
                        else
                        {
                            ...
                            vel = MathUtil.FromPolar(aimAngle + randomSpread, 40f * .5f);
                            EntityManager.Add(new Bullet(EntityManager.Resources.Bullet, Position + offset, vel, Bullet.BULLETTYPE.PLAYER, 1));
            ...
            if (lastSlowMoState != GameplayScreen.IsSlowMotion)
            {
                ...
                if (stupidAuxForSlowMoMessage == 1)
                {
                    ...
                    EntityManager.Add(new FadingOutMessage(this.Position + new Vector2(0, 60), "Badass", 240));
                    EntityManager.Add(new FadingOutImageMessage(this.Position + new Vector2(110, 60), EntityManager.Resources.SlowTimeMessageIco, 240));
                    EntityManager.Add(new FadingOutMessage(this.Position + new Vector2(170, 60), "Time", 240));
                    EntityManager.Add(new FadingOutMessage(this.Position + new Vector2(80, 90), "On", 240));
                ...
                else if (stupidAuxForSlowMoMessage == 2)
                {
                    ...
                    EntityManager.Add(new FadingOutImageMessage(this.Position + new Vector2(110, 60), EntityManager.Resources.SlowTimeMessageIco, 240));
                    EntityManager.Add(new FadingOutMessage(this.Position + new Vector2(170, 60), "Time", 240));
                    EntityManager.Add(new FadingOutMessage(this.Position + new Vector2(80, 90), "Off", 240));
        ...
        {
            EntityManager.Add(new FadingOutMessage(this.Position, "OUCH!", 60 * 2));
        ...
        public void Kill()
        {
            ...
            framesUntilRespawn = 120 * 2;
            timeUntilActive = 100 * 2;
            ...
            for (int i = 0; i < 5000; i++)
            {
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.Particle, Position, color, 100 * 2, 1.5f, state);
            }

            GameplayScreen.FreezeTime = 30 * 2;
        ...
        private void makeExhaustFire()
        {
            ...
            if (Velocity.LengthSquared() > 0.1f)
            {
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, pos, sideColor * alpha, 60f, new Vector2(0.5f, 1),
                    new ParticleState(velMid, ParticleType.ENEMY));
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, pos, midColor * alpha, 60f, new Vector2(0.5f, 1),
                    new ParticleState(vel1, ParticleType.ENEMY));
