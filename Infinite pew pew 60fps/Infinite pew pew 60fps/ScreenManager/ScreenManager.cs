...
namespace GameStateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        Texture2D pixel;
        public Texture2D WebsiteIco;
        public Texture2D FacebookIco;
        public Texture2D TwitterIco;
        public Texture2D GamejoltIco;
        public Texture2D IndiedbIco;

        public SoundEffect PopUp;
        public SoundEffect PopOff;
        public SoundEffect Select;
        public SoundEffect StartGame;
        public SoundEffect BackToMenu;
        public SoundEffect KeyboardSound;
        ...
        protected override void LoadContent()
        {
            ...
            FacebookIco = content.Load<Texture2D>("Sprites/facebookIco");
            TwitterIco = content.Load<Texture2D>("Sprites/twitterIco");
            WebsiteIco = content.Load<Texture2D>("Sprites/websiteIco");

            PopUp = content.Load<SoundEffect>("Sounds/UISounds/PopUp");
            PopOff = content.Load<SoundEffect>("Sounds/UISounds/PopOff");
            Select = content.Load<SoundEffect>("Sounds/UISounds/Select");
            StartGame = content.Load<SoundEffect>("Sounds/UISounds/StartGame");
            BackToMenu = content.Load<SoundEffect>("Sounds/UISounds/BackToMenu");
            KeyboardSound = content.Load<SoundEffect>("Sounds/UISounds/vintagekeyboard");
        ...
        private float volume = .5f, pitch = 0, pan=0;
        public void playPopUp()
        {
            PopUp.Play(.8f, pitch, pan);
        }

        public void playPopOff()
        {
            PopOff.Play(.8f, pitch, pan);
        }

        public void playSelect()
        {
            Random random = new Random();
            Select.Play(volume,random.NextFloat(-.5f, .2f), pan);
        }

        public void playStartGame()
        {
            StartGame.Play(.8f,pitch, pan);
        }

        public void playBackToMenu()
        {
            BackToMenu.Play(.8f, pitch, pan);
        }
        ...
        public void DrawWithoutShaders(GameTime gameTime)
        {
            base.Draw(gameTime);
        }
