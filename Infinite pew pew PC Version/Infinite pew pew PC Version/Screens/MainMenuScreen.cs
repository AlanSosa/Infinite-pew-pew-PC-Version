...
namespace GameStateManagement
{
    ...
    class MainMenuScreen : MenuScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            */
            ImageTouchableEntry facebookEntry = new ImageTouchableEntry(ScreenManager.FacebookIco, new Vector2(ScreenManager.GraphicsDevice.Viewport.Width - (imageWidth + xPos + imageWidth * 2) - 30, ScreenManager.GraphicsDevice.Viewport.Height - imageWidth / 2), 30);
            xPos += 15;
            ImageTouchableEntry twitterEntry = new ImageTouchableEntry(ScreenManager.TwitterIco, new Vector2(ScreenManager.GraphicsDevice.Viewport.Width - (imageWidth + xPos + imageWidth), ScreenManager.GraphicsDevice.Viewport.Height - imageWidth / 2), 30);
            xPos += 15;
            ImageTouchableEntry websiteEntry = new ImageTouchableEntry(ScreenManager.WebsiteIco, new Vector2(ScreenManager.GraphicsDevice.Viewport.Width - imageWidth, ScreenManager.GraphicsDevice.Viewport.Height - imageWidth / 2), 30);
        ...
        void ExitMenuEntrySelected(object sender, PlayerIndexEventArgs e)
        {
            ...
            confirmQuitMessageBox.AcceptedEntry = new TouchableEntry("OK: Enter, A", 20);
            confirmQuitMessageBox.CancelledEntry = new TouchableEntry("No: Esc, B", 20);
        ...
        protected override void OnCancel(PlayerIndex playerIndex)
        {
            ...
            confirmQuitMessageBox.AcceptedEntry = new TouchableEntry("Yeap", 20);
            confirmQuitMessageBox.CancelledEntry = new TouchableEntry("Nope", 20);
            confirmQuitMessageBox.AcceptedEntry.Selected += ConfirmQuitMessageBoxAccepted;
