...
namespace ThridWolrdShooterGame
{
    ...
    class GameplayScreen : GameScreen
    {
            ...
            if (IsActive)
            {
                ...
                if (PlayerStatus.IsGameOver)
                {
                    ...
                    if (timeToDisplayGameOver > 4000)
                    {
                        ...
                        confirmQuitMessageBox.AcceptedEntry = new TouchableEntry("A: Ok", 20);
                        confirmQuitMessageBox.CancelledEntry = new TouchableEntry("B: Cancel", 20);
                        ...
                        if (displayInput)
                        {
                            ...
                            insertNameMessageBox.AcceptedEntry = new TouchableEntry("A , Enter : Save", 20);
        ...
        public override void HandleInput(InputState input)
        {
            ...
            PlayerIndex player;
            if (input.IsNewButtonPress(Buttons.Back, ControllingPlayer, out player) || input.IsPauseGame(player))
            {
        ...
        private void DrawRightAlignedString(string text, float y)
        {
            ...
            spriteBatch.DrawString(EntityManager.Resources.DemoFont, text, new Vector2(graphicsWidth - textWidth - 5, y), Color.White);
        }
