...
namespace ThridWolrdShooterGame.Entites.Items
{
    public class Amigo:Entity
    {
        ...
        {
            this.Velocity += ((Target - this.Position) * 0.05f) *  GameplayScreen.SlowMoMultiplier;
            Vector2 aim;
        ...
        private void makeExhaustFire()
        {
            ...
            if (Velocity.LengthSquared() > 0.1f)
            {
               ...
               // Orientation = Velocity.ToAngle();
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, pos, midColor * alpha, 7f, new Vector2(0.5f, 1),
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, pos, sideColor * alpha, 5f, new Vector2(0.5f, 1),
