...
namespace ThridWolrdShooterGame.Entites
{
    public class Rockets:Bullet
    {
        ...
        public override void Update(GameTime gametime)
        {
            ...
            this.Velocity += this.acceleration *GameplayScreen.SlowMoMultiplier;
        ...
        {/*
            ...
            if (Velocity.LengthSquared() > 0.1f)
            {
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, pos, midColor * alpha, 4f, new Vector2(0.5f, 1),
                ...
                GameplayScreen.ParticleManager.CreateParticle(EntityManager.Resources.SquareParticle, pos, sideColor * alpha, 2.5f, new Vector2(0.5f, 1),
