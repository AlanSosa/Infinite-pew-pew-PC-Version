...
namespace ThridWolrdShooterGame.Entites.Enemies
{
    ...
    public class EnemyBarricade:Enemy
    {
        ...
        private int spanTimeToSpawnEnemies;

        public EnemyBarricade(Vector2 Position, int enemiesToSpawn, int spanTimeToSpawnEnemies)
        {
            ...
            this.AddBehaviour(this.MoveInCircles(100, 50f));
        ...
        public override void Update(Microsoft.Xna.Framework.GameTime gameTime)
        {
            ...
            if (EntityManager.CanSpawnEnemyBullets)
            {
                if ((GameplayScreen.GameTime.TotalGameTime.Milliseconds / 500) % 3 == 0)
                {
                    ...
                    Vector2 vel = MathUtil.FromPolar(aim.ToAngle(), (PlayerStatus.Level >= 15 ? 15f : 10f));
